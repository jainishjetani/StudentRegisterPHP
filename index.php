...
//        $port = 3306;
        ...
        $query = "INSERT INTO `studenttable`(`name`, `email`, `city`, `phone`, `department`) VALUES ('" . $stud_name . "','" . $stud_email . "','" . $stud_city . "','" . $stud_phone . "','" . $stud_department . "')";
    ...
    <center>
        ...
        <a href="view.php">Click To View Students</a>
    </center>
</body>
</html>
